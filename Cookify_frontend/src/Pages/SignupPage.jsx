                ...
                <div className="relative z-10 max-w-sm w-full space-y-12 animate-reveal">
                    ...
                    <div className="space-y-6">
                        <h1 className="text-6xl font-extrabold text-gray-900 leading-[1.1] font-heading">
                            The Art of<br />
                            <span className="text-[#2E7D32]">Cooking.</span>
                        </h1>
                        <p className="text-xl text-gray-500 leading-relaxed font-medium">
                            Join our premium community of home chefs. Discover techniques, share your masterpieces, and ignite your culinary passion.
                        </p>
                    </div>
            ...
            <div className="flex items-center justify-center p-8 lg:p-16 bg-white overflow-y-auto">
                <div className="w-full max-w-md space-y-10 animate-reveal py-8">
                    ...
                    <div className="space-y-3">
                        <h2 className="text-4xl font-bold text-gray-900 font-heading tracking-tight">Create Account</h2>
                        <p className="text-gray-500 text-lg">Start your culinary journey today.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="grid grid-cols-2 gap-4">
                            <Input label="Full Name" name="fullName" value={formData.fullName} onChange={handleChange} error={errors.fullName} placeholder="Jane Doe" />
                            <Input label="Username" name="username" value={formData.username} onChange={handleChange} error={errors.username} placeholder="jane_cooks" />
                        </div>

                        <Input label="Email Address" type="email" name="email" value={formData.email} onChange={handleChange} error={errors.email} placeholder="jane@example.com" />
